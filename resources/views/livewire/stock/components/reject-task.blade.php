            ...
            <div class="card shadow-none bg-transparent border border-danger mb-3">
                <div class="card-body">
                    <div class="card-title header-elements">
                        <h5 class="m-0 me-2">Reject</h5>
                        <div class="card-title-elements ms-auto">
                            <span class="badge bg-danger rounded-pill">{{ $pendingApprovedCount }}</span>
                        </div>
                    </div>
                        ...
                        @forelse ($pendingApproved as $data)
                            <div class="accordion-item card">
                                <li class="d-flex align-items-center accordion-button collapsed"
                                    data-bs-toggle="collapse" data-bs-target="#reject-{{ $data->id }}"
                                    ...
                                    <div
                                        ...
                                        <div class="me-2">
                                            ...
                                            <span class="badge rounded-pill bg-label-danger">{{ $data->status }}</span>
                                            <span class="badge rounded-pill bg-label-danger">{{ $data->pekerjaan }}</span>
                                        </div>
                                    </div>
                                </li>
                                <div id="reject-{{ $data->id }}" class="accordion-collapse collapse">
                                    ...
                                    aria-controls="offcanvasScroll" role="button" @click="$dispatch('show-off-canvas', {id:{{ $data->instruction_id }}})">
                                        <li class="d-flex justify-content-center align-items-center mb-3">
                                            <a href="form-request-stock/{{ $data->id }}" class="btn btn-outline-danger me-3">
